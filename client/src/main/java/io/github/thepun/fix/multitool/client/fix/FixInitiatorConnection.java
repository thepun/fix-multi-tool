...
import static quickfix.SessionFactory.INITIATOR_CONNECTION_TYPE;
import static quickfix.SessionFactory.SETTING_CONNECTION_TYPE;

final class FixInitiatorConnection implements FixConnection, Application {
    ...
    FixInitiatorConnection(Params params) {
        lock = new Object();
        ...
        sessionSettings.setString(currentSession.getSessionID(), SETTING_CONNECTION_TYPE, INITIATOR_CONNECTION_TYPE);
        ...
        sessionSettings.setString(currentSession.getSessionID(), SETTING_SOCKET_CONNECT_HOST, params.getString("host"));
        sessionSettings.setLong(currentSession.getSessionID(), SETTING_SOCKET_CONNECT_PORT, params.getInt("port"));
        ...
        try {
            threadedSocketInitiator = new ThreadedSocketInitiator(this, storeFactory, sessionSettings, log, messageFactory, Integer.MAX_VALUE);
